package com.victon.tpms.http.base;
...
public class HttpClient {
    ...
    public static boolean isNetworkAvailable() {
        try {
            ConnectivityManager connectivityManager = (ConnectivityManager) VictonBaseApplication.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static void get(String url, Map<String, String> param, final HttpResponseHandler httpResponseHandler) {
        if (!isNetworkAvailable()) {
            Toast.makeText(VictonBaseApplication.getInstance(), R.string.no_network_connection_toast, Toast.LENGTH_SHORT).show();
            return;
        }
